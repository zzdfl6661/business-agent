...
def get_traffic_data(
    ...
    cached = cache_get("get_traffic_data", params)
...
def get_store_ranking(
    ...
    """
    params = {"weights": weights, "top_n": top_n}
    cached = cache_get("get_store_ranking", params)
    if cached is not None:
        return cached
    ...
    try:
        ...
        cache_set("get_store_ranking", params, result)  # #7 TTL 缓存
        return result
    except Exception as exc:
